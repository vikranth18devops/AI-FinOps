# 08 - Custom Domain & GoDaddy DNS Integration on Azure AKS

<p align="left">
  <img src="https://img.shields.io/badge/GoDaddy-DNS-1B1B1B?style=for-the-badge&logo=godaddy&logoColor=white" />
  <img src="https://img.shields.io/badge/Azure_AKS-LoadBalancer-0089D6?style=for-the-badge&logo=microsoft-azure&logoColor=white" />
...
## ⚡ Step 6: (Optional) Reserve Azure Static Public IP Address

By default, Azure assigns an ephemeral LoadBalancer IP. To prevent IP changes if Traefik is redeployed, promote your public IP to an Azure Static Public IP inside `finops-global-rg`:
...
# Reserve static public IP address in Azure
az network public-ip create \
  --resource-group $RG_NAME \
  --name traefik-static-pip \
  --location $LOCATION \
