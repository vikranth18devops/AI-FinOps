# 04 - Create Kubernetes Namespaces & Azure RBAC

## 📌 Step Overview
In this step, you will isolate cluster workloads by creating dedicated Kubernetes namespaces (`finops` and `observability`) and setting up Role-Based Access Control (RBAC) security guardrails.
