# 07 - ArgoCD GitOps Continuous Deployment Setup on GKE
...
## 📌 Step Overview
Deploy the complete FinOps application stack (**React Frontend**, **FastAPI Backend**, **UI_Script Provisioner Studio**, and **In-Cluster PostgreSQL**) using an automated **GitOps continuous delivery loop** powered by **ArgoCD** on GCP GKE.
...
[GitHub Repo: vikranth18devops/AI-FinOps]
      ...
      [GCP GKE Cluster (finops namespace)]
```
...
Next Step: **[08-Custom Domain & GoDaddy DNS Integration](08-godaddy-dns-gcp.md)**
